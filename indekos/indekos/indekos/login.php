      ...
      <div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
        <div class="card card-signin my-5">
          <div class="card-body">
              ...
              <h2 class="card-title text-center">Sistem pendukung keputusan pemilihan indekos terbaik di sekitar kampus menggunakan
                 metode topsis studi kasus kelurahan purwanegara</h2>
                        
                <p class="card-title text-center"><img src="images/amikom.jpeg" width="100"></p>
